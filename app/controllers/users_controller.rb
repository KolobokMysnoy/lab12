...
class UsersController < ApplicationController
  ...
  def user_params
    ...
    # user_params = params.require(:user).permit(:name, :password, :password_confirmation) # don't permit `password_digest` here, that database column should not be allowed to be set by the user!
